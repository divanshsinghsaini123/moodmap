...
//       await res.json();
//       await loadStats(); // refresh counters after vote
//     } catch (err) {
...
//           <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-900/70 border border-slate-700 text-xs text-slate-300 mb-3">
//             <span className="text-emerald-400">●</span>
//             Live global mood check
//           </div>
...
//             Cast your mood and watch the world map light up with everyone&apos;s vibes.
//           </p>
//         </header>

//         {/* Layout: Poll on top, Map below */}
//         <main className="flex flex-col gap-8">
//           {/* Poll Card */}
//           <section className="w-full bg-slate-900/80 border border-slate-700/80 rounded-3xl p-6 sm:p-8 shadow-[0_0_60px_rgba(15,23,42,0.65)] backdrop-blur">
//             {!lastVote ? (
//               <div className="space-y-6">
//                 <div className="flex items-center justify-between gap-3">
//                   <div>
//                     <h2 className="text-xl sm:text-2xl font-semibold">What kind of day are you having?</h2>
//                     <p className="text-slate-400 text-sm mt-1">
//                       Be honest — your vote is anonymous.
//                     </p>
//                   </div>
//                   {grandTotal > 0 && (
...
//                     disabled={loading}
//                     className="group relative rounded-2xl p-6 bg-gradient-to-tr from-emerald-600 to-emerald-400 text-left
//                                hover:scale-[1.02] active:scale-[0.99] transform transition duration-150 focus:outline-none
//                                shadow-[0_0_40px_rgba(16,185,129,0.45)] disabled:opacity-70"
//                   >
//                     <div className="flex items-center justify-between gap-3">
//                       <div>
//                         <div className="text-lg font-semibold flex items-center gap-2">
//                           😊 Good day
//                           <span className="text-xs px-2 py-0.5 rounded-full bg-emerald-900/40 border border-emerald-200/40">
//                             Positive
//                           </span>
//                         </div>
//                         <div className="text-sm text-emerald-50/90 mt-1">
//                           Feeling productive, peaceful, or just fine.
//                         </div>
//                       </div>
//                     </div>
//                   </button>
...
//                     disabled={loading}
//                     className="group relative rounded-2xl p-6 bg-gradient-to-tr from-rose-600 to-rose-400 text-left
//                                hover:scale-[1.02] active:scale-[0.99] transform transition duration-150 focus:outline-none
//                                shadow-[0_0_40px_rgba(244,63,94,0.45)] disabled:opacity-70"
//                   >
//                     <div className="flex items-center justify-between gap-3">
//                       <div>
//                         <div className="text-lg font-semibold flex items-center gap-2">
//                           😞 Bad day
//                           <span className="text-xs px-2 py-0.5 rounded-full bg-rose-900/40 border border-rose-200/40">
//                             It happens
//                           </span>
//                         </div>
//                         <div className="text-sm text-rose-50/90 mt-1">
//                           Stress, chaos, or just not your day.
//                         </div>
//                       </div>
//                     </div>
//                   </button>
...
//                           lastVote === "good"
//                             ? "bg-emerald-900/40 border-emerald-300/60 text-emerald-100"
//                             : "bg-rose-900/40 border-rose-300/60 text-rose-100"
//                         }`}
//                       >
//                         You chose {lastVote === "good" ? "Good day" : "Bad day"}
//                       </span>
//                     </h2>
//                     <p className="text-slate-400 text-sm mt-1">
//                       Here&apos;s how the world is feeling overall.
//                     </p>
//                   </div>
...
//                             lastVote === "good" ? "bg-emerald-500" : "bg-emerald-400/90"
//                           }`}
//                           style={{ width: `${goodPct}%` }}
//                         />
//                       </div>
...
//                         <div
//                           className={`h-full rounded-full transition-all duration-700 ${
//                             lastVote === "bad" ? "bg-rose-500" : "bg-rose-400/90"
//                           }`}
//                           style={{ width: `${badPct}%` }}
//                         />
//                       </div>
